...
import sat.diot.npsi.core.NPSICoord

// COMMAND ----------

var pendientes:String = ""
class GeneracionCsvDeltas
{
  ...
  def generaCsvDeltasOro()
  {    
    pendientes = NPSICoord.procesaPendientes()
...
// DBTITLE 1,Main
val instancia = new GeneracionCsvDeltas()
instancia.generaCsvDeltasOro()
